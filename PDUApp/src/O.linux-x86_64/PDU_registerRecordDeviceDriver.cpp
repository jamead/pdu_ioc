...
/* Generated from ../O.Common/PDU.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_register_func_ChanStatus, pvar_func_register_func_ChanSub,
    pvar_func_register_func_StatusSub;
...
int PDU_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/Diag/PDU/ioc";
    ...
    runRegistrarOnce(pvar_func_register_func_ChanStatus);
    runRegistrarOnce(pvar_func_register_func_ChanSub);
    runRegistrarOnce(pvar_func_register_func_StatusSub);
    iocshRegisterVariable(vardefs);
    return 0;
}

/* PDU_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: PDU_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(PDU_registerRecordDeviceDriver(*iocshPpdbbase));
}
